...
const SelectControl: React.FC<{ label: string; value: string; onChange: (e: React.ChangeEvent<HTMLSelectElement>) => void; options: readonly string[] }> = ({ label, value, onChange, options }) => (
    <div>
...
const Settings: React.FC = () => {
    ...
    return (
        <div className="space-y-8 max-w-2xl mx-auto">
            ...
            <SettingsSection title={t('settings.tabs.agent')}>
                <SelectControl 
            ...
            <SettingsSection title={t('settings.tabs.data')}>
                 <SelectControl 
